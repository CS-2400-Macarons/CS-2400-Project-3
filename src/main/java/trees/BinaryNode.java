...
class BinaryNode<T>
{
   ...
   /**A Recursion Example in the trees.BinaryNode Class
   ...
   /** --------------------------------------------------------------------
    * Part of Task 1 */
   /** A Recursive Method in the trees.BinaryNode Class
   ...
   {  
      ...
      {
         height = 1 + leftChild.getHeight_binaryNodeMethod();
         return height;
      }
      else if (rightChild != null)
      {
         height = 1 + rightChild.getHeight_binaryNodeMethod();
         return height;
      }
